# @TIME : 2019/3/27 上午6:44
# @File : cnn_text_classification.py
...
parser.add_argument('-epochs', type=int, default=256, help='number of epoch for train')
...
def load_dataset(text_field, label_field, args, **kwargs):
    ...
    train_iter, dev_iter = data.Iterator.splits(
        ...
        batch_size=(args.batch_size, len(dev_dataset)),
...
args.cuda = args.device != -1 and torch.cuda.is_availabel()
